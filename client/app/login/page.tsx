...
export default function Login() {
    ...
    return (
        <div className="min-h-screen relative pt-24 pb-12 overflow-hidden flex items-center justify-center">
            {/* Background Blobs (inherited from global styles or added here for specific positioning if needed, but body has mesh, so just need main content) */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
                <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-primary/20 rounded-full blur-[100px] animate-blob" />
                <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-brand-secondary/20 rounded-full blur-[100px] animate-blob animation-delay-2000" />
            </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div>
                        <div className="flex justify-between items-center mb-2">
                            ...
                            <a href="#" className="text-xs text-brand-accent hover:text-brand-primary transition-colors">Forgot password?</a>
                        </div>
                        <div className="relative group">
                    ...
                    <div className="text-center mt-6">
                        <p className="text-sm text-gray-400">
                            Don't have an account? <Link href="/register" className="text-brand-accent hover:text-white font-medium transition-colors">Create one now</Link>
                        </p>
                    </div>
                </form>
            </div>
